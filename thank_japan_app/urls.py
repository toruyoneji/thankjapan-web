...
from .views import (TopView, TopViewFR, TopViewIT, TopViewPT, TopViewZHHANT,TopViewKO, TopViewESES, TopViewZHCN,
                    ...
                    game_answer, game_result, game_restart, daily_question_view, player_login, player_logout, delete_player_confirm,
...
urlpatterns = [
    ...
    path('daily/', daily_question_view, name='daily_question'),
